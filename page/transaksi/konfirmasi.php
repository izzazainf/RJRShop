                ...
                <div class="container">
                        ...
                        <table class="table table-striped">
                                ...
                                <tr>
                                        ...
                                        <?php
                                        if($data["pembayaran_status"]=="pembayaran belum")
                                        {

                                        ?>
                                        <td> 
                                            <form action="?page=unggah" method="post">
                                            <input type="hidden" name="idtransaksi" value="<?php echo $data["transaksi_id"];?>">
                                            <button type="submit" class="btn btn-save" name="konfirmasi">Konfirmasikan</button>
                                            </form>
